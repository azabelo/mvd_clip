...
def main(args, ds_init):
    ...
    train_video_embeddings, train_targets = precompute_train_video(model, data_loader_train).clone().detach().to(device)
    test_video_embeddings, test_targets = precompute_test_video(model, data_loader_val).clone().detach().to(device)
